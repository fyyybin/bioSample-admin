<template>
    <div class="content">
        ...
        <div class="contentMain">
            <div class="content-main">
                <div style="display: flex; flex-direction: row;">
                    ...
                    <div class="input">
                        <el-button plain class="btn" :icon="Search" @click="">搜索</el-button>
            ...
            <div label-width="auto" style="padding: 0px 15px;">
                ...
                <div class="input">
                    ...
                    <el-select v-model="new_from" class="textbox">
                        <el-option v-for="item in sampleType"
                            :label="item.label"
                            :value="item.label">
                        </el-option>
                    </el-select>
                ...
                <div class="input">
                    ...
                    <el-select v-model="new_hospital" class="textbox" style="margin-left: 15px;">
                        <el-option v-for="item in hospital"
                            :label="item"
                            :value="item">
                        </el-option>
                    </el-select>
        ...
        <!--修改样本源-->
        <el-dialog v-model="agreeDialog" width="430" 
            align-center
            :close-on-click-modal="false"
...
const submitData = ( new_name, new_from, new_hospital) => {
    if (new_hospital=='' || new_name=='' || new_from=='')
        tips('warning','表格不能为空！')
    else {
        let params = {
            "样本源姓名": new_name,
